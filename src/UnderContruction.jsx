  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
      <div className="max-w-lg w-full bg-gray-800/50 rounded-lg shadow-lg p-8 border border-gray-700">
        ...
        {/* Payment Due Notice */}
        <p className="text-center text-red-500 font-mono text-sm mt-6">
          Payment is due. If you are the owner, please contact Nuvion Technologies at{' '}
          <a href="mailto:info@nuviontech.com" className="text-red-400 hover:text-red-300">
            info@nuviontech.com
          </a>.
        </p>
        ...
        {/* Contact */}
        <p className="text-center text-gray-500 font-mono text-xs mt-6">
          Contact: <a  className="text-gray-400 hover:text-gray-300">+91 8799523738</a>
        </p>
